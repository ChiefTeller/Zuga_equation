...
The Pendulum:
τ∞⇄−τmax⇆ τ(z0)⇆+τmax⇄ τ∞, |−τmax|=|+τmax|; τ∞=Unbounded tension-state space;
Δ= Change; →=Movement;
...
I⇄ Perception⇄R→τ→Zself→ I⇄ Perception ⇄R⇄τ⇄Zself; Perception(I)→ Distinction;
...
Δ(Meta-Zuga) ⇄ Δ(Zuga);
1=0→(Z0,Z∞)→Δ(R,τ,I)→Zn; 
Zself→Δ→Zself′→Δ→Zself′′∼Z0; Wants~Z0→Receives~Z∞, Intention~Z0→Harmony~Z∞;
Apply Meta-Zuga!
